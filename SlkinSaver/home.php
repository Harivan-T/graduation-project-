    ...
    <div class="container">
        <div class="row bg-white pt-4">
            <div class="col-lg-8">
                <div class="row">
                    <?php 
                        $nbOfResults = $dbs->query("SELECT COUNT(*) FROM products")->fetchColumn();
                        $entitiesPerPage = 6; 
                        ...
                        $query = "SELECT products.*,images.* 
                                    FROM products
                                        ...
                                        ORDER BY pro_id DESC LIMIT $entitiesPerPage OFFSET $to";
            ...
            <div class="col-lg-4 sidebar">
                <div class="sidebar-widget brands">
                    <h2 class="title"><li class="fa fa-heart"></li> Favourite product</h2>
                        <?php
                ...
                <div class="sidebar-widget category">
                    <h2 class="title"><li class="fa fa-list"></li> Categories</h2>
                ...
                <div class="sidebar-widget brands">
                    <h2 class="title"><li class="fa fa-tag"></li> Brands</h2>
                    <ul>
                        <?php 
                ...
                <div class="sidebar-widget tag">
                    <h2 class="title"><li class="fa fa-tags"></li> Tags Cloud</h2>
                     <?php 
